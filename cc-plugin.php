...
function culture_collide_cpt() {
  ...
  //Ad post type
  register_post_type( 'ad_space', array(
    'labels' => array(
      'name' => 'Ad Spaces',
      'singular_name' => 'Ad Space',
      'menu_name' => 'Ad Space',
      'name_admin_bar' => 'Ad Space',
      'add_new' => 'Add New',
      'add_new_item' => 'Add New Ad Space',
      'edit_item' => 'Edit Ad Space',
      'new_item' => 'New Ad Space',
      'view_item' => 'View Ad Space',
      'search_items' => 'Search Ad Spaces',
      'not_found' => 'No Ad Spaces found',
      'not_found_in_trash' => 'No Ad Spaces in the trash.',
      'all_items' => 'Ad Spaces',
     ),
    'description' => 'Ad Spaces will show ads located on the Culture Collide website.',
    'public' => true,
    'menu_position' => 2,
  ...
  register_post_type( 'event', array(
    ...
    'description' => 'Events are post types that will be used in the Event section of the Culture Collide website.',
    'public' => true,
    'menu_position' => 2,
    'supports' => array( 'title', 'editor', 'thumbnail', 'excerpt' ),
    'show_in_nav_menus' => true,
